...
public class NoteController {
	 ...
	 */
	ApplicationContext applicationConext = new ClassPathXmlApplicationContext("beans.xml");
	NoteRepository noteRepository = applicationConext.getBean("noteRepository", NoteRepository.class);
	...
	{
		map.addAttribute("notes", noteRepository.getAllNotes());
		return "index";
	}
	...
	*/
	...
	public String addNote(@ModelAttribute("note") Note note, ModelMap map)
	{
	...
	*/
	...
	public String deleteNote(@RequestParam("noteId") int noteId, ModelMap map)
	{
